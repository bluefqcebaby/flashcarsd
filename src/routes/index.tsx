...
import type { IntegrationReport } from '#/lib/integration-types'
...
function App() {
  ...
  return (
    <main className="page-wrap px-4 pb-8 pt-14">
      ...
      <section className="island-shell mt-8 rounded-2xl p-6">
        <p className="island-kicker mb-2">Iteration 1: Integration Check</p>
        <p className="mb-4 max-w-2xl text-sm text-[var(--sea-ink-soft)]">
          Validates Drizzle + Postgres connection, confirms the flashcards
          table exists, and runs a real OpenAI API request.
        </p>
        <button
          type="button"
        ...
        {requestError ? (
          <p className="mt-4 text-sm text-red-700">Request error: {requestError}</p>
        ) : null}
